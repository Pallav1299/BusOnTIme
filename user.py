...
def find_current_stop(location_tuple):
	...
	for i in range(len(Bus_Stop_Location)):
		...
		if (stop_lat == bus_lat) and (stop_lon == bus_lon):
...
while 1:
	...
	print("")
	"""
	print(bus_list[0] + " has reached: " + i)
	print(bus_list[1] + " has reached: " + j)
	print(bus_list[2] + " has reached: " + k)
	print(" ")
	#print(i,j,k)
	"""