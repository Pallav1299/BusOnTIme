...
const char* ssid = "busOnTime";
const char* password = "poiuytrewq";

// The ID below comes from Google Sheets, where the data will be posted

//const char *GScriptId = "AKfycby0PSqsjIJskJucORycdCq-PkzTZS7Q9bv3giw5dxpt7xQymcQ";  //Sheet "Bus On Time"

const char *GScriptId = "AKfycbzo1CFf0OrTo9VPEIVVM8zPVRvtPHValNSL9diJx2Qlg-VSBNI";  // Sheet "Check Bus On Time"
